...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-media-library', __webpack_require__(3));
  Vue.component('detail-nova-media-library', __webpack_require__(6));
  Vue.component('form-nova-media-library', __webpack_require__(9));
});
